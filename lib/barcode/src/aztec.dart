...
// non-optimal states.
  ...
  List<_State> _updateStateForPair(
    ...
    result
        .add(stateNoBinary.latchAndAppend(_EncodingMode.punct, pairCode));
    if (s.mode != _EncodingMode.punct) {
      // Possibility 2.  Shift to MODE_PUNCT, and then append this code.
      // Every state except MODE_PUNCT (handled above) can shift
      result.add(
          stateNoBinary.shiftAndAppend(_EncodingMode.punct, pairCode));
    }
...
// output in Binary Shift mode.
  _State addBinaryShiftChar(int index) {
    ...
    var mode = this.mode;
    var bitCnt = bitCount;
    if (this.mode == _EncodingMode.punct ||
        this.mode == _EncodingMode.digit) {
